...
# Execute the sbatch command, passing the shell script content
process = subprocess.run(['sbatch'], input=shell_script_content, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
